  ...
  return (
    <div className={style.bg}>
      <div className={style.container}>
        ...
        {todos.length < 1 ? <p className={style.count}>You have no tasks remaining</p> : <p className={style.count}>You have {todos.length} tasks remaining</p> }
      </div>
    </div>
  );
}
